    ...
    return (
        <div className="bg-white">
            <div className="mx-auto max-w-2xl px-4 pb-24 pt-16 sm:px-6 lg:max-w-7xl lg:px-8">
                <h1 className="font-bold tracking-tight text-gray-900 sm:text-4xl text-3xl">Shopping Cart</h1>
                <div className="mt-12 lg:grid lg:grid-cols-12 lg:items-start lg:gap-x-12 xl:gap-x-16">
                    <div className={cn('lg:col-span-7', {
                        ...
                        <h2 className="sr-only">Items in your shopping cart
                        </h2>
                    ...
                    <section className="mt-16 rounded-lg bg-gray-50 px-4 py-6 sm:px-6 lg:col-span-5 lg:mt-0 lg:p-8">
                        ...
                        <div className="mt-6 space-y-4">
                            ...
                            {isMounted && items.length > 0 && <div className="flex items-center justify-between border-t border-gray-200 pt-4">
                            ...
                            <div className="mt-6">
                                <Button disabled={isMounted && items.length === 0} className="w-full" size={'lg'}>
                                    Checkout
                                </Button>
                            </div>
                        </div>
